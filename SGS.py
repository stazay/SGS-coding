...
class Hand(Deck):
    ...
    def discard_from_equip_or_hand(self, num=1):
        while num > 0:
            ...
            if len(players[0].equipment_offensive_horse) > 0:
                options_str.append(
                    str(players[0].equipment_offensive_horse[0]))
            else:
                options_str.append(
                    Separator("  -----------<Empty Horse Slot>------------  "))
            if len(players[0].equipment_defensive_horse) > 0:
                options_str.append(
                    str(players[0].equipment_defensive_horse[0]))
            else:
                options_str.append(
                    Separator("  -----------<Empty Horse Slot>------------  "))
    ...
    def play_reaction_effect(self, card_played, reaction_required, player_index=None, reacting_player_index=None, player_reacting_list=[]):
        ...
        while reactions_possible:
            print(" ")
            if reaction_required == "Brink Of Death":
    ...
    def use_card_effect(self, card_index, card):
            ...
            if (players[0].attacks_this_turn == 0) or (players[0].check_berserk()) or (len(players[0].equipment_weapon) > 0 and players[0].equipment_weapon[0].effect == 'Zhuge Crossbow'):
                ...
                if len(choices_index) > 0:
                    ...
                    if not isinstance(card_index, str):
                        ...
                        print("This card will behave as an ATTACK.")
                    ...
                    if answer_2.get('Selected') == 'Yes':
                        ...
                        attack_defended = choices[selected_player].hand_cards.play_reaction_effect(
                            card, "Attack", 0, selected_player, choices)
        ...
        if card.effect2 == 'Peach':
            ...
            if players[0].max_health > players[0].current_health:
                if not isinstance(card_index, str):
                    ...
                    print("This card will behave as a PEACH.")
                question = [
                    {
                        'type': 'list',
                        'name': 'Selected',
            ...
            question = [
                {
                    'type': 'list',
                    'name': 'Selected',
                    'message': f'{players[0].character}: Please select a character to target with {card} as {card.effect2.upper()}.',
                    'choices': choices_str,
                    'filter': lambda player: choices_str.index(player)
                },
            ]
            ...
            question_2 = [
                {
                    'type': 'list',
                    'name': 'Selected',
                    'message': f'{players[0].character}: Please confirm you would like to use {card} against {choices[selected_player].character} as {card.effect2.upper()}?',
                    'choices': ['Yes', 'No'],
                },
            ]
            answer_2 = prompt(question_2, style=custom_style_2)
            if answer_2.get('Selected') == 'Yes':
                ...
                if cards_discardable > 0:
                    ...
                    options_str.append(
                        Separator("-----------------HAND--CARDS-----------------"))
                    i = 1
                    for item in (choices[selected_player].hand_cards.contents):
                ...
                question_3 = [
                    {
                        'type': 'list',
                        'name': 'Selected',
                        'message': f'{players[0].character}: Please select which card you would like to DISMANTLE:',
                        'choices': options_str,
                        'filter': lambda card: options_str.index(card)
                    },
                ]
                ...
                if card_dismantled_index <= len(choices[selected_player].hand_cards.contents):
                    ...
                    print(
                        f"{players[0].character} has DISMANTLED {card_dismantled} from {choices[selected_player].character}'s hand by using {card}.")
                ...
                if card_dismantled_index > len(choices[selected_player].hand_cards.contents):
                    if card_dismantled_index == (len(choices[selected_player].hand_cards.contents) + 2):
                        ...
                        print(
                            f"{players[0].character} has DISMANTLED {card_dismantled} from {choices[selected_player].character}'s weapon-slot by using {card}.")
                        ...
                        discard_deck.add_to_top(card_dismantled)
                        print(
                            f"{players[0].character} has DISMANTLED {card_dismantled} from {choices[selected_player].character}'s armor-slot by using {card}.")
                        choices[selected_player].check_warrior_woman()
                        ...
                        discard_deck.add_to_top(card_dismantled)
                        print(
                            f"{players[0].character} has DISMANTLED {card_dismantled} from {choices[selected_player].character}'s horse-slot by using {card}.")
                        choices[selected_player].check_warrior_woman()
        ...
        if card.effect2 == 'Greed':
            ...
            if not isinstance(card_index, str):
                ...
                print("This card will behave as GREED.")
            question = [
                {
                    'type': 'list',
                    'name': 'Selected',
        ...
        if card.effect2 == 'Steal':
            ...
            if stealing_possible:
                question = [
                    {
                        'type': 'list',
                        'name': 'Selected',
                        'message': f'{players[0].character}: Please select a character to use {card} against as {card.effect2.upper()}.',
                        'choices': choices_str,
                        'filter': lambda player: choices_str.index(player)
                    },
                ]
                ...
                if not isinstance(card_index, str):
                    ...
                    print("This card will behave as a STEAL.")
                question_2 = [
                    {
                        'type': 'list',
                        'name': 'Selected',
            ...
            question = [
                {
                    'type': 'list',
                    'name': 'Selected',
                    'message': f'{players[0]}: Please select a player to target with {card} as {card.effect2.upper()}.',
                    'choices': choices,
            ...
            question_2 = [
                {
                    'type': 'list',
                    'name': 'Selected',
                    'message': f'{players[0].character}: Please confirm you would like to use {card} against {players[selected_player].character} as {card.effect2.upper()}?',
                    'choices': ['Yes', 'No'],
                },
            ]
            answer_2 = prompt(question_2, style=custom_style_2)
        ...
        # card.type == 'Weapon' or card.type == 'Armor' or card.type == '+1 Horse' or card.type == '-1 Horse':
        if card.type == 'Weapon':
            if players[0].equipment_weapon == []:
                ...
                message = f'{players[0].character}: Please confirm you would like to equip {card.effect} and replace {players[0].equipment_weapon}.'
                print(f"{card} - {card.flavour_text}")
                popping = True
            question = [
                {
        ...
        if card.type == 'Armor':
            if players[0].equipment_armor == []:
                ...
                message = f'{players[0].character}: Please confirm you would like to equip {card.effect} and replace {players[0].equipment_armor}.'
                print(f"{card} - {card.flavour_text}")
                popping = True
            question = [
                {
        ...
        if card.type == '+1 Horse':
            if players[0].equipment_defensive_horse == []:
                ...
                message = f'{players[0].character}: Please confirm you would like to equip {card.effect} and replace {players[0].equipment_defensive_horse}.'
                print(f"{card} - {card.flavour_text}")
                popping = True
            question = [
                {
        ...
        if card.type == '-1 Horse':
            if players[0].equipment_offensive_horse == []:
                ...
                message = f'{players[0].character}: Please confirm you would like to equip {card.effect} and replace {players[0].equipment_offensive_horse}.'
                print(f"{card} - {card.flavour_text}")
                popping = True
            question = [
                {
    ...
    def check_pending_judgements(self):
        if self.pending_judgements == []:
            ...
            while len(self.pending_judgements) > 0:
                ...
                # Check for secondary card effects (Da Qiao, Xu Huang)
                if pending_judgement.effect2 == 'Acedia':
                    ...
                    pending_judgement.effect2 = None
        ...
        if (self.character_ability1 == "Eternal Loyalty: For every one unit of damage you suffer, you can allow any player of your choice (including yourself) to replenish that player’s on-hand cards to their maximum health level." or self.character_ability2 == "Eternal Loyalty: For every one unit of damage you suffer, you can allow any player of your choice (including yourself) to replenish that player’s on-hand cards to their maximum health level." or self.character_ability3 == "Eternal Loyalty: For every one unit of damage you suffer, you can allow any player of your choice (including yourself) to replenish that player’s on-hand cards to their maximum health level." or self.character_ability4 == "Eternal Loyalty: For every one unit of damage you suffer, you can allow any player of your choice (including yourself) to replenish that player’s on-hand cards to their maximum health level." or self.character_ability5 == "Eternal Loyalty: For every one unit of damage you suffer, you can allow any player of your choice (including yourself) to replenish that player’s on-hand cards to their maximum health level."):
            while damage_dealt > 0:
                ...
                if len(options_str) > 2:
                    ...
                    answer_2 = prompt(question_2, style=custom_style_2)
                    if answer_2.get('Selected') == (len(options_str) - 1):
                        damage_dealt = 0
                    else:
            ...
            if (self.character_ability1 == "Fearsome Advance: Whenever your ATTACK is evaded by a DEFEND, you can discard one of your opponents cards (on-hand or equipped)." or self.character_ability2 == "Fearsome Advance: Whenever your ATTACK is evaded by a DEFEND, you can discard one of your opponents cards (on-hand or equipped)." or self.character_ability3 == "Fearsome Advance: Whenever your ATTACK is evaded by a DEFEND, you can discard one of your opponents cards (on-hand or equipped)." or self.character_ability4 == "Fearsome Advance: Whenever your ATTACK is evaded by a DEFEND, you can discard one of your opponents cards (on-hand or equipped)." or self.character_ability5 == "Fearsome Advance: Whenever your ATTACK is evaded by a DEFEND, you can discard one of your opponents cards (on-hand or equipped)."):
                ...
                if answer.get('Selected') == 'Yes':
                    ...
                    options_str.append(
                        Separator("-----------------HAND--CARDS-----------------"))
                    i = 1
                    for item in choices[selected_player_index].hand_cards.contents:
                        options_str.append(f"Hand-Card {i}")
                        i += 1
                    options_str.append(
                        Separator("---------------EQUIPPED--CARDS---------------"))
                    if len(choices[selected_player_index].equipment_weapon) > 0:
                        options_str.append(
                            str(choices[selected_player_index].equipment_weapon[0]))
                    else:
                        options_str.append(
                            Separator("  -----------<Empty Weapon Slot>-----------  "))
                    if len(choices[selected_player_index].equipment_armor) > 0:
                        options_str.append(
                            str(choices[selected_player_index].equipment_armor[0]))
                    else:
                        options_str.append(
                            Separator("  -----------<Empty Armor Slot>------------  "))
                    if len(choices[selected_player_index].equipment_offensive_horse) > 0:
                        options_str.append(
                            str(choices[selected_player_index].equipment_offensive_horse[0]))
                    else:
                        options_str.append(
                            Separator("  -----------<Empty Horse Slot>------------  "))
                    if len(choices[selected_player_index].equipment_defensive_horse) > 0:
                        options_str.append(
                            str(choices[selected_player_index].equipment_defensive_horse[0]))
                    else:
                        options_str.append(
                            Separator("  -----------<Empty Horse Slot>------------  "))
                    ...
                    answer_2 = prompt(question_2, style=custom_style_2)
                    card_discarded_index = answer_2.get('Selected')
                ...
                if answer_1.get('Selected') == 'Yes':
                    ...
                    if target_2 == "Cancel":
                        ...
                        options_str.append(
                            Separator("-----------------HAND--CARDS-----------------"))
                        i = 1
                        for item in target_1.hand_cards.contents:
                            options_str.append(f"Hand-Card {i}")
                            i += 1
                    ...
                    if target_2 != "Target noone else":
                        ...
                        options_str.append(
                            Separator("-----------------HAND--CARDS-----------------"))
                        i = 1
                        for item in target_2.hand_cards.contents:
                            options_str.append(f"Hand-Card {i}")
                            i += 1
                ...
                if cards_discardable > 0:
                    ...
                    if answer_1.get('Selected') == 'Yes':
                        ...
                        options_str.append(
                            Separator("-----------------HAND--CARDS-----------------"))
                        i = 1
                        for item in players[source_player_index].hand_cards.contents:
                            options_str.append(f"Hand-Card {i}")
                            i += 1
                        options_str.append(
                            Separator("---------------EQUIPPED--CARDS---------------"))
                        if len(players[source_player_index].equipment_weapon) > 0:
                            options_str.append(
                                str(players[source_player_index].equipment_weapon[0]))
                        else:
                            options_str.append(
                                Separator("  -----------<Empty Weapon Slot>-----------  "))
                        if len(players[source_player_index].equipment_armor) > 0:
                            options_str.append(
                                str(players[source_player_index].equipment_armor[0]))
                        else:
                            options_str.append(
                                Separator("  -----------<Empty Armor Slot>------------  "))
                        if len(players[source_player_index].equipment_offensive_horse) > 0:
                            options_str.append(
                                str(players[source_player_index].equipment_offensive_horse[0]))
                        else:
                            options_str.append(
                                Separator("  -----------<Empty Horse Slot>------------  "))
                        if len(players[source_player_index].equipment_defensive_horse) > 0:
                            options_str.append(
                                str(players[source_player_index].equipment_defensive_horse[0]))
                        else:
                            options_str.append(
                                Separator("  -----------<Empty Horse Slot>------------  "))
                        ...
                        answer_2 = prompt(question_2, style=custom_style_2)
                        card_stolen_index = answer_2.get('Selected')
            ...
            if cards_discardable > 0:
                ...
                if len(usable_cards) < 1:
                    ...
                    if options[discarded_index].suit == "Spades" or options[discarded_index].suit == "Clubs":
                        ...
                        print(
                            f"  >> Character Ability: Surprise; {self.character} has discarded {card} to use as a DISMANTLE.")
                ...
                if cards_discardable > 0:
                    ...
                    if not len(choices_str) > 2:
                        ...
                        if answer.get('Selected') == len(choices_str) - 1:
                            ...
                            options_str.append(
                                Separator("-----------------HAND--CARDS-----------------"))
                            playing_card_options = get_playing_card_options(
                                self.hand_cards)
                            for card in playing_card_options:
                                options_str.append(card)
                            options_str.append(
...
# Action Phase
    def start_action_phase(self):
        ...
        while action_phase_active:
            ...
            answer_1 = prompt(question_1, style=custom_style_2)
            action_taken_index = answer_1.get('Selected')
